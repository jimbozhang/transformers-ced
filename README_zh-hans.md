...
1. **[CED](https://huggingface.co/docs/transformers/model_doc/ced)** (来自 Xiaomi) 伴随论文 [CED: Consistent ensemble distillation for audio tagging](https://arxiv.org/abs/2308.11957) by Heinrich Dinkel, Yongqing Wang, Zhiyong Yan, Junbo Zhang, Yujun Wang 发布。
