...
1. **[CED](https://huggingface.co/docs/transformers/model_doc/ced)** (Xiaomi から) Heinrich Dinkel, Yongqing Wang, Zhiyong Yan, Junbo Zhang, Yujun Wang から公開された研究論文: [CED: Consistent ensemble distillation for audio tagging ](https://arxiv.org/abs/2308.11957)
